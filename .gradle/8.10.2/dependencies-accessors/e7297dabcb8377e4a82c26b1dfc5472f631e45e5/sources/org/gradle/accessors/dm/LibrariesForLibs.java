...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>emdk</b> with <b>com.symbol:emdk</b> coordinates and
     * with version reference <b>emdk</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getEmdk() {
        return create("emdk");
    }

    /**
     * Dependency provider for <b>jcifs</b> with <b>org.samba.jcifs:jcifs</b> coordinates and
     * with version reference <b>jcifs</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getJcifs() {
        return create("jcifs");
    }
    ...
    /**
     * Dependency provider for <b>photoview</b> with <b>io.getstream:photoview</b> coordinates and
    ...
    /**
     * Dependency provider for <b>rxkotlin</b> with <b>io.reactivex.rxjava3:rxkotlin</b> coordinates and
    ...
    /**
     * Dependency provider for <b>safebox</b> with <b>io.github.harrytmthy:safebox</b> coordinates and
     * with version reference <b>safebox</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getSafebox() {
        return create("safebox");
    }
    ...
    /**
     * Dependency provider for <b>treessence</b> with <b>com.github.bastienpaulfr:Treessence</b> coordinates and
     * with version reference <b>treessence</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getTreessence() {
        return create("treessence");
    }
    ...
    /**
     * Group of libraries at <b>tink</b>
     */
    ...
    public static class TinkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>android</b> with <b>com.google.crypto.tink:tink-android</b> coordinates and
         * with version reference <b>tinkAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>commonsIo</b> with value <b>2.19.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>coreSplashscreen</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>emdk</b> with value <b>9.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getEmdk() { return getVersion("emdk"); }
        ...
        /**
         * Version alias <b>jcifs</b> with value <b>1.3.14-kohsuke-1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinReflect</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>loggingInterceptor</b> with value <b>3.12.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>photoview</b> with value <b>1.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxkotlin</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>safebox</b> with value <b>1.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSafebox() { return getVersion("safebox"); }
        ...
        /**
         * Version alias <b>tinkAndroid</b> with value <b>1.20.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTinkAndroid() { return getVersion("tinkAndroid"); }

        /**
         * Version alias <b>treessence</b> with value <b>1.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTreessence() { return getVersion("treessence"); }
