...
class InvoiceFragmentPr : BaseFragment() {
                ...
                .apply {
                    ...
                    containerVertical.setOnClickListener {
                        invoicesViewModel.mainActivityRouter.navigate(
                            ...
                            Bundle().apply {
                                putSerializable(InvoiceFragmentLinesPr.PARAMS_INVOICE_ID,itemData.id)
                                putSerializable(InvoiceFragmentLinesPr.PARAMS1_INVOICE_NAME,itemData.number)
                                putSerializable(InvoiceFragmentLinesPr.PARAM_YARL,itemData.yarlnum)
                                putSerializable(InvoiceFragmentLinesPr.PARAM_YARLNAME,itemData.yarl)
                                putSerializable(InvoiceFragmentLinesPr.PARAMS2_COLLECTED,itemData.collected)
